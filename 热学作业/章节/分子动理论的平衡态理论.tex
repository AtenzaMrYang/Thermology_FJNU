    ...
    $$
        \begin{aligned}
            F(\varepsilon)\,\mathrm{d}\varepsilon
             ...
             & = \frac{2}{\sqrt{\pi}}\left(\frac{1}{kT}\right)^{3/2} \exp\left(-\frac{\varepsilon}{kT}\right) \sqrt{\varepsilon} \,\mathrm{d}\varepsilon                                                              \\
        \end{aligned}
    $$
...
\begin{solution}
    ...
    $$
    我们在此处引入误差函数 $\displaystyle \operatorname{erf}(x) = \frac{2}{\sqrt{\pi}}\int_0^x \exp(-t^2) \,\mathrm{d}t$，上式化为
    $$
        \begin{aligned}
            \frac{\mathrm{d}N}{N}
...
\begin{solution}
    ...
    $$
        p_1(t) = \frac{p_0}{2} \cdot \left[1+\exp\left(-\frac{A\bar{v}}{2V}t\right) \right]
    $$
